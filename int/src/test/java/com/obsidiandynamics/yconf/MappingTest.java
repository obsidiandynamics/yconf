...
public final class MappingTest {
  ...
  public void testNormal() throws IOException {
    final FooBar fb = (FooBar) new MappingContext()
        ...
        .fromStream(MappingTest.class.getClassLoader().getResourceAsStream("context-test.yaml"), FooBarIface.class);
  ...
  public void testWithoutMapper() throws IOException {
    final Object obj = new MappingContext()
        .withParser(new SnakeyamlParser())
        .fromStream(MappingTest.class.getClassLoader().getResourceAsStream("context-test.yaml"), FooBar.class);
    assertNotNull(obj);
